...
const brandColorMap = {
  ...
  JavaScript:
    "hover:border-yellow-400/70 hover:text-yellow-300 hover:bg-yellow-400/10",
  TypeScript: "hover:border-sky-400/70 hover:text-sky-300 hover:bg-sky-400/10",
  "Node.js":
    "hover:border-emerald-500/70 hover:text-emerald-300 hover:bg-emerald-500/10",
  "Express.js": "hover:border-slate-400 hover:text-white hover:bg-slate-800",
  "Spring Boot":
    "hover:border-green-500/70 hover:text-green-300 hover:bg-green-500/10",
  "REST API Design":
    "hover:border-cyan-500/70 hover:text-cyan-300 hover:bg-cyan-500/10",
  JWT: "hover:border-purple-500/70 hover:text-purple-300 hover:bg-purple-500/10",
  "OpenAI API":
    "hover:border-teal-400/70 hover:text-teal-300 hover:bg-teal-400/10",
  "React.js":
    "hover:border-cyan-400/70 hover:text-cyan-300 hover:bg-cyan-400/10",
  "Tailwind CSS":
    "hover:border-teal-400/70 hover:text-teal-300 hover:bg-teal-400/10",
  PostgreSQL:
    "hover:border-indigo-400/70 hover:text-indigo-300 hover:bg-indigo-400/10",
  MySQL:
    "hover:border-orange-400/70 hover:text-orange-300 hover:bg-orange-400/10",
  MongoDB:
    "hover:border-emerald-400/70 hover:text-emerald-300 hover:bg-emerald-400/10",
...
const OpenSourceLogo = ({ skillName }) => {
  ...
  const needsInversion =
    skillName === "Express.js" || skillName === "OpenAI API";
